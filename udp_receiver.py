...
def write(data):
  data_input = str(data)
  phone_validation = re.search(r'(\d{2,3}\d{2,4}\d{4})', data_input)
  num_validation = re.search(r'([0-9]{2}(0[1-9]|1[0-2])(0[1-9]|[1,2][0-9]|3[0,1]))', data_input)
  id_validation = re.search(r'[a-zA-Z0-9+-\_.]+%40+[a-zA-Z0-9-]+\.[a-zA-Z0-9-.]', data_input)
  if phone_validation:
      print("\n#######Warning!!!! Risk of personal information leakage!!")
  elif num_validation:    
      print("\n#######Warning!!!! Risk of personal information leakage!!")
  elif id_validation:
      print("\n#######Warning!!!! Risk of personal information leakage!!")
